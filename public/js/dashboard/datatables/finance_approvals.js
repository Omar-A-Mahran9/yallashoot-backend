            ...
            ajax: {
                data: function () {
                    ...
                    datatable
                        .DataTable()
                        .ajax.url(
                            `/dashboard/finance-approvals?page=${
                                info.page + 1
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/finance-approvals/${
                                        row.id
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="/dashboard/finance-approvals/pdf/${
                                        row.id
                                    }" class="menu-link px-3 d-flex justify-content-between edit-row" >
                                       <span> ${__("PDF")} </span>
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3 d-flex justify-content-between delete-row" data-row-id="${
                                        row.id
                                    }" data-type="${__("Finance approvals")}">
                                       <span> ${__("Delete")} </span>
            ...
            deleteAlert(type).then(function (result) {
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        url: "/dashboard/finance-approvals/" + rowId,
                        success: () => {
                            setTimeout(() => {
                                successAlert(
                                    `${
