        ...
        datatable = $("#kt_datatable").DataTable({
            ...
            ajax: {
                data: function () {
                    ...
                    datatable.DataTable().ajax.url(`/dashboard/offers?page=${info.page + 1}&per_page=${info.length}`);
                }
            },
            columns: [
                {data: 'id'},
            ...
            columnDefs: [
                ...
                },
                {
                    targets: 2,
                    render: function (data, type, row) {
                        return `<img style="height:50px;width:50px;border-radius:4px" src="${getImagePathFromDirectory(data, 'Offers')}" class="me-3" >`;
                    }
                },
                {
                    targets: -1,
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    ...
                                    <a href="/dashboard/offers/${ row.id }/edit" class="menu-link px-3 d-flex justify-content-between edit-row" >
                                       <span> ${__('Edit')} </span>
                                ...
                                <div class="menu-item px-3">
                                    ...
                                    <a href="/dashboard/offers/${ row.id }" class="menu-link px-3 d-flex justify-content-between" >
                                       <span> ${__('Show')} </span>
