...
return [
    ...
    */
    ...
    'attributes' => [
        'banks'=>'بنك',
        'team_one_id' => 'الفريق الأول',
        'team_two_id' => 'الفريق الثاني',
        'channel_ids' => 'القنوات',
        'playground_id' => 'الملعب',
        'league_id' => 'الدوري',
        "end_time"=>"وفت نعاية المباراة",
        "start_time"=>"وفت بداية المباراة",
        "start_date"=>"تاريخ بداية المباراة",
        "country_id"=>"الدولة",
        ...
        'banks'=>'بنك',
        'teamـoneـid' => 'الفريق الأول',
        'teamـtwoـid' => 'الفريق الثاني',
        'playgroundـid' => 'الملعب',
        'leagueـid' => 'الدوري',
        "endـtime"=>"وفت نعاية المباراة",
        "startـtime"=>"وفت بداية المباراة",
        "startـdate"=>"تاريخ بداية المباراة",
        '' => '',
        '' => '',
        '' => '',
        '' => '',
