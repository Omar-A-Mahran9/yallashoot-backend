...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.player.store') }}" class="form" method="post" id="submitted-form"
                data-redirection-url="{{ route('dashboard.player.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Add new player') }}</h3>
                </div>
                <!-- end   :: Card header -->
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="number" class="form-control" id="player_no-sp" name="player_no"
                                placeholder="{{ __('Enter your player no') }}" />
                            <!-- Add any necessary validation feedback here -->
