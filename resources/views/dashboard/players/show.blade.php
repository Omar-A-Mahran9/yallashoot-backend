        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a
                        ...
                        class="text-muted text-hover-primary">{{ __('Player') }}</a></h1>
                <!-- end   :: Title -->
        ...
        <div class="card-body p-0">
            ...
            <form class="form">
                ...
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('player') . ' : ' . $player->name }}</h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="inputs-wrapper">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_ar_inp" name="name_ar"
                                    placeholder="example" value="{{ $player->name_ar }}" readonly />
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_en_inp" name="name_en"
                                    placeholder="example" value="{{ $player->name_en }}" readonly />
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="input-group mb-5">
                                <input type="text" class="form-control" id="phone_inp" name="phone"
                                    value="{{ $player->phone }}" placeholder="{{ __('Enter the phone') }}" readonly />
                            </div>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="email_inp" name="email"
                                    placeholder="example" value="{{ $player->email }}" readonly />
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="number" class="form-control" id="player_no-sp" name="player_no"
                                placeholder="{{ __('Enter your player no') }}" value="{{ $player->player_no }}" readonly/>
                            <!-- Add any necessary validation feedback here -->
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control" rows="4" name="description_ar" id="meta_tag_description_ar_inp" readonly>{{ $player->description_ar }}</textarea>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control" rows="4" name="description_en" id="meta_tag_description_en_inp" readonly>{{ $player->description_en }}</textarea>
