...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.delegates.update', $delegate->id) }}" class="form" method="post"
                id="submitted-form" data-redirection-url="{{ route('dashboard.delegates.index') }}">
                @csrf
                @method('PUT')
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Edit a delegate') . ' : ' . $delegate->name }}</h3>
                </div>
                <!-- end   :: Card header -->
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_inp" name="name"
                                    value="{{ $delegate['name'] }}" placeholder="example" />
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="input-group mb-5 form-floatin">
                                ...
                                <input type="text" class="form-control" id="phone_inp" name="phone"
                                    value="{{ __(str_replace('966', ' ', $delegate['phone'])) }}"
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="commission_inp" name="commission"
                                    value="{{ $delegate['commission'] }}" placeholder="example" />
                            ...
                            <select class="form-select" data-control="select2" name="bank_id" id="banks-sp"
                                ...
                                @foreach ($banks as $bank)
                                    <option value="{{ $bank->id }}"
                                        {{ $bank->id == $delegate->bank_id ? 'selected' : '' }}> {{ $bank->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="IBAN_inp" name="IBAN"
                                    value="{{ $delegate['IBAN'] }}" placeholder="example" />
