                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <select disabled class="form-select" data-control="select2" name="team_one_id"
                                id="team_one_id-sp" data-placeholder="{{ __('Choose the team number one') }}"
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <select disabled class="form-select" data-control="select2" name="team_two_id"
                                id="team_two_id-sp" data-placeholder="{{ __('Choose the team number two') }}"
                                data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                <option value="" selected></option>
                                @foreach ($teams as $team)
                                    <option value="{{ $team->id }}"
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <select disabled class="form-select" data-control="select2" name="country_id" id="country_id-sp"
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <select disabled class="form-select" data-control="select2" name="playground_id"
                                id="playground_id-sp" data-placeholder="{{ __('Choose the playground') }}"
                                data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                <option value="" selected></option>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <select disabled class="form-select" data-control="select2" name="league_id" id="league_id-sp"
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <select disabled class="form-select" data-control="select2" name="channel_ids[]" multiple
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <select disabled class="form-select" data-control="select2" name="status" id="status-sp"
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea readonly disabled class="form-control" rows="4" name="description_ar"
                                id="meta_tag_description_ar_inp">{{ $game->description_ar }}</textarea>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea readonly disabled class="form-control" rows="4" name="description_en"
                                id="meta_tag_description_en_inp">{{ $game->description_en }}</textarea>
