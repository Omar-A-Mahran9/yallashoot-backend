...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.games.store') }}" class="form" method="post" id="submitted-form"
                data-redirection-url="{{ route('dashboard.games.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Add new game') }}</h3>
                </div>
                <!-- end   :: Card header -->
                    ...
                    <div class="row mb-8">
                        <div class="col-md-3 fv-row">
                            ...
                            <input type="date" class="form-control" id="start_date-en" name="start_date"
                                placeholder="{{ __('Enter Game Date') }}" />
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <select class="form-select" data-control="select2" name="status" id="status-sp"
                                ...
                                @foreach ($statues as $statue)
                                    <option value="{{ $statue }}"> {{ __($statue) }}</option>
                                @endforeach
                            </select>
