    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('Games') }}</h1>
                <!-- end   :: Title -->
        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <div class="d-flex flex-stack flex-wrap mb-15">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    <!-- begin :: Add Button -->
                    <a href="{{ route('dashboard.games.create') }}" class="btn btn-primary" data-bs-toggle="tooltip"
                        title="">
            ...
            <table data-ordering="false" id="kt_datatable" class="table text-center table-row-dashed fs-6 gy-5">
                ...
                <thead>
                    <tr class="text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                        <th>#</th>
                        <th>{{ __('team number one') }}</th>
                        <th>{{ __('team number two') }}</th>
                        <th>{{ __('country') }}</th>
                        <th>{{ __('statue') }}</th>
                        <th>{{ __('Game Date') }}</th>
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/games.js') }}"></script>
    <script>
