...
<div class="toolbar">
    ...
    <div class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            ...
            <!-- begin :: Title -->
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __("Packages") }}</h1>
            <!-- end   :: Title -->
        ...
        <table data-ordering="false" id="kt_datatable" class="table text-center table-row-dashed fs-6 gy-5">
            ...
            <thead>
                <tr class="text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <!-- <th>{{ __("monthly price after discount") }}</th> -->
                    <!-- <th>{{ __("annual price after discount") }}</th> -->
                    <!-- <th>{{ __("discount from date") }}</th> -->
                    <!-- <th>{{ __("discount to date") }}</th> -->
                    <!-- <th>{{ __("value") }}</th> -->
