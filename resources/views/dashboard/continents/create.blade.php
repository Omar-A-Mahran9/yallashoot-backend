...
@section('content')
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a
                        href="{{ route('dashboard.continent.index') }}"
                        class="text-muted text-hover-primary">{{ __('Continents') }}</a></h1>
                <!-- end   :: Title -->
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.continent.store') }}" class="form" method="post" id="submitted-form"
                data-success-message="{{ __('continent added successfully') }}"
                data-redirection-url="{{ route('dashboard.continent.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">

                    <div class="card-title">
                        <h3 class="fw-bolder text-dark">{{ __('Add new continent') }}</h3>
                    </div>
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <label class="fs-5 fw-bold mb-2">{{ __('continent title in arabic') }}</label>
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title_ar"
                                    placeholder="example" />
                                <label for="title_inp">{{ __('Enter the continents title in arabic') }}</label>
                            </div>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <label class="fs-5 fw-bold mb-2">{{ __('continent title in english') }}</label>
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title_en"
                                    placeholder="example" />
                                <label for="title_inp">{{ __('Enter the continents title in english') }}</label>
                            </div>
