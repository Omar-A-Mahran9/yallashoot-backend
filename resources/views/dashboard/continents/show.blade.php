...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.continent.update', $continent->id) }}" class="form" method="post"
                id="submitted-form" data-redirection-url="{{ route('dashboard.continent.index') }}">
                @csrf
                @method('PUT')
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <div class="card-title">
                        <h3 class="fw-bolder text-dark">{{ __('Edit continent') . ' : ' . $continent->title }}</h3>
                    </div>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-12 fv-row d-flex justify-content-evenly">
                            ...
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <div>
                                    <x-dashboard.upload-image-inp name="main_image" :image="$continent['main_image']" directory="Continents"
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title_ar"
                                    value="{{ $continent['title_ar'] }}" placeholder="example" readonly />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title_en"
                                    value="{{ $continent['title_en'] }}" placeholder="example" readonly />
                ...
                <div class="form-footer">
                    ...
                    <!-- begin :: Submit btn -->
                    <!-- begin :: Submit btn -->
                    <a href="{{ route('dashboard.continent.index') }}" class="btn btn-primary">
