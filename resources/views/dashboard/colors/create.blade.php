...
@section('content')
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a
                        href="{{ route('dashboard.colors.index') }}"
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.colors.store') }}" class="form" method="post" id="submitted-form"
                data-redirection-url="{{ route('dashboard.colors.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center justify-content-between">
                    <div class="card-title">
                        <h3 class="fw-bolder text-dark">{{ __('Add new color') }}</h3>
                    </div>
                    <div class="card-title">

                        <div class="form-check form-check-custom form-check-solid mx-4">
                            {{-- <input class="form-check-input" type="radio" value="image" name="color_type" id="image-radio-btn"   />
                            <label class="form-check-label me-10" for="image-radio-btn"> {{ __("image") }} </label> --}}

                            <input class="form-check-input" type="radio" value="color" name="color_type"
                                id="color-radio-btn" checked />
                ...
                <div class="inputs-wrapper">
                    ...
                    <!-- begin :: Row -->
                    <div class="row mb-8" id="image-container" style="display:none">
                    ...
                    <!-- begin :: Row -->
                    <div class="row mb-4" id="colors-container">

                        <!-- begin :: Column -->
                        <div class="col-md-6 fv-row">

                            <label class="fs-5 fw-bold mb-2" for="hex_code_inp">{{ __('Color') }}</label>
                            <input type="color" name="hex_code" class="form-control" id="hex_code_inp" value=""
                                style="height:47.5px" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control" name="hex_code" value="#000000" id="color_code_inp"
                                readonly />
