    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('Colors') }}</h1>
                <!-- end   :: Title -->
        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <div class="d-flex flex-stack flex-wrap mb-15">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    <!-- begin :: Add Button -->
                    <a href="{{ route('dashboard.colors.create') }}" class="btn btn-primary" data-bs-toggle="tooltip"
                        title="">
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/colors.js') }}"></script>
    <script>
