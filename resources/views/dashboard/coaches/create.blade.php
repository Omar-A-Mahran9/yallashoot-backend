...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.coache.store') }}" class="form" method="post" id="submitted-form"
                data-redirection-url="{{ route('dashboard.coache.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Add new coache') }}</h3>
                </div>
                <!-- end   :: Card header -->
