...
@section('content')
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a
                        ...
                        class="text-muted text-hover-primary">{{ __('Coaches') }}</a></h1>
                <!-- end   :: Title -->
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.coache.update', $coach->id) }}" class="form" method="post"
                id="submitted-form" data-redirection-url="{{ route('dashboard.coache.index') }}">
                @csrf
                @method('PUT')
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Edit an coache') . ' : ' . $coach->name }}</h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="inputs-wrapper">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_ar_inp" name="name_ar"
                                    placeholder="example" value="{{ $coach->name_ar }}" />
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_en_inp" name="name_en"
                                    placeholder="example" value="{{ $coach->name_en }}" />
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="input-group mb-5">
                                <input type="text" class="form-control" id="phone_inp" name="phone"
                                    value="{{ $coach->phone }}" placeholder="{{ __('Enter the phone') }}" />
                            </div>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="email_inp" name="email"
                                    placeholder="example" value="{{ $coach->email }}" />
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control" rows="4" name="description_ar" id="meta_tag_description_ar_inp">{{ $coach->description_ar }}</textarea>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control" rows="4" name="description_en" id="meta_tag_description_en_inp">{{ $coach->description_en }}</textarea>
