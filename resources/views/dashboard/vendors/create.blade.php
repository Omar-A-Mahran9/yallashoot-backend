...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.vendors.store') }}" class="form" method="post" id="submitted-form"
                data-redirection-url="{{ route('dashboard.vendors.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Add new vendor') }}</h3>
                </div>
                <!-- end   :: Card header -->
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <select class="form-select" name="type" id="type-sp"
                                    ...
                                    data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                    <option value=""></option>
                                    <option value="individual" selected>{{ __('Individual') }}</option>
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="google_maps_url_inp"
                                        name="google_maps_url" placeholder="example" />
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <select class="form-select" name="package_id"
                                    data-placeholder="{{ __('Packages list') }}"
                                    data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                    <option value=""></option>
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="form-floating">
                                    ...
                                    <label
                                        for="password_confirmation_inp">{{ __('Enter the password confirmation') }}</label>
                                </div>
