        ...
        <div class="card-body p-0">
            ...
            <form class="form">
                ...
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('team') . ' : ' . $team->title }}</h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="inputs-wrapper">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_ar_inp" name="title_ar"
                                    placeholder="example" value="{{ $team->title_ar }}" readonly/>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_en_inp" name="title_en"
                                    placeholder="example" value="{{ $team->title_en }}" readonly/>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control" rows="4" name="description_ar" id="meta_tag_description_ar_inp" disabled>{{ $team->description_ar }}</textarea>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control" rows="4" name="description_en" id="meta_tag_description_en_inp" disabled>{{ $team->description_en }}</textarea>
