...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.playground.store') }}" class="form" method="post" id="submitted-form"
                data-success-message="{{ __('playground added successfully') }}"
                data-redirection-url="{{ route('dashboard.playground.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">

                    <div class="card-title">
                        <h3 class="fw-bolder text-dark">{{ __('Add new Playground') }}</h3>
                    </div>
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <label class="fs-5 fw-bold mb-2">{{ __('playground title in arabic') }}</label>
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title_ar"
                                    placeholder="example" />
                                <label for="title_inp">{{ __('Enter the playgrounds title in arabic') }}</label>
                            </div>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <label class="fs-5 fw-bold mb-2">{{ __('playground title in english') }}</label>
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title_en"
                                    placeholder="example" />
                                <label for="title_inp">{{ __('Enter the playgrounds title in english') }}</label>
                            </div>
