    ...
    <div class="toolbar">
        ...
        <div  class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __("Finance approvals") }}</h1>
                <!-- end   :: Title -->
        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <div class="d-flex flex-stack flex-wrap mb-15">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    <!-- begin :: Add Button -->
                    <a href="{{ route('dashboard.finance-approvals.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title="">
            ...
            <table data-ordering="false" id="kt_datatable" class="table text-center table-row-dashed fs-6 gy-5">
                ...
                <tr class="text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th>{{ __("Tax discount") }}</th>
                    <th>{{ __("Discount percent") }}</th>
                    <th>{{ __("Discount amount") }}</th>
                    <th>{{ __("Cashback percent") }}</th>
                    <!-- <th>{{ __("Cashback amount") }}</th> -->
                    <th>{{ __("Cost") }}</th>
                    <!-- <th>{{ __("Plate no cost") }}</th> -->
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/finance_approvals.js') }}"></script>
    <!-- <script>
