...
@section('content')
    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a href="{{ route('dashboard.tags.index') }}"
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.tags.store') }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.tags.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __("Add new tag") }}</h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="color" name="bg_color" class="form-control" id="bg_color_inp" value="" style="height:47.5px"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control" name="bg_color" value="#000000" id="color_code_inp" readonly/>
