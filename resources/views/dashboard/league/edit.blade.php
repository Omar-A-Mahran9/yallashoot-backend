...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.league.update', $leagues->id) }}" class="form" method="post"
                id="submitted-form" data-redirection-url="{{ route('dashboard.league.index') }}">
                @csrf
                @method('PUT')
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <div class="card-title">
                        <h3 class="fw-bolder text-dark">{{ __('Edit leagues') . ' : ' . $leagues->title }}</h3>
                    </div>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title_ar"
                                    value="{{ $leagues['title_ar'] }}" placeholder="example" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title_en"
                                    value="{{ $leagues['title_en'] }}" placeholder="example" />
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control" rows="4" name="description_ar" id="meta_tag_description_en_inp"
                                data-kt-autosize="true">{!! $leagues['description_ar'] !!}</textarea>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control" rows="4" name="description_en" id="meta_tag_description_en_inp"
                                data-kt-autosize="true">{!! $leagues['description_en'] !!}</textarea>
