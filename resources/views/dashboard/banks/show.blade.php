        ...
        <div class="card-body p-0">
            ...
            <form class="form">
                ...
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('bank') . ' : ' . $bank->name }}</h3>
                </div>
                <!-- end   :: Card header -->
                    ...
                    <div class="row mb-20">
                        ...
                        <div class="col-md-12 fv-row d-flex justify-content-evenly">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <x-dashboard.upload-image-inp name="image" :image="$bank['image']" directory="Banks"
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" value="{{ $bank['name_ar'] }}" readonly />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" value="{{ $bank['name_en'] }}" readonly />
                            </div>
                ...
                <div class="form-footer">
                    ...
                    <!-- begin :: Submit btn -->
                    <a href="{{ route('dashboard.banks.index') }}" class="btn btn-primary">
