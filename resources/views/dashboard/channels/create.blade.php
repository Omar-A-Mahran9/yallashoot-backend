...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.channel.store') }}" class="form" method="post" id="submitted-form"
                data-redirection-url="{{ route('dashboard.channel.index') }}">
                @csrf
                <!-- begin :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="commenter_name_ar_inp"
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="commenter_name_en_inp"
                    ...
                    <div class="fv-row row mb-15">
                        ...
                        <div class="col-md-12">
                            ...
                            <div id="form_repeater">
                                <!--begin::Form group-->
                                <input type="text" hidden name='deletedsatellites[]' id='deletedSatelliteInput'>
                                        ...
                                        <div data-repeater-item>
                                            <div class="form-group row mt-5">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <p class="invalid-feedback" id="satellites_0_nmae">
                                                    </p>
                                                </div>
                                                <div class="col-md-2">
                                                    <label class="form-label">{{ __('Frequency') }}</label>
                                                    <input type="text" class="form-control mb-2 mb-md-0"
                                                        name="frequency" placeholder="{{ __('Enter frequency') }}" />
                                                    <p class="invalid-feedback" id="satellites_0_frequency">
                                                    </p>
                                                </div>
                                                <div class="col-md-2">
                                                    ...
                                                    <p class="invalid-feedback" id="satellites_0_polarization"></p>
                                                </div>
                                                <div class="col-md-2">
                                                    <label class="form-label">{{ __('Modulation') }}</label>
                                                    <input type="text" class="form-control mb-2 mb-md-0"
                                                        name="modulation" placeholder="{{ __('Enter modulation') }}" />
                                                    <p class="invalid-feedback" id="satellites_0_modulation"></p>
                                                </div>
                                                <div class="col-md-2">
                                                    <label class="form-label">{{ __('Correction') }}</label>
                                                    <input type="text" class="form-control mb-2 mb-md-0"
                                                        name="correction" placeholder="{{ __('Enter correction') }}" />
                                                    <p class="invalid-feedback" id="satellites_0_correction"></p>
                                                </div>
                                                <div class="col-md-2">
                                                    <label class="form-label">{{ __('Encryption') }}</label>
                                                    <input type="text" class="form-control mb-2 mb-md-0"
                                                        name="encryption" placeholder="{{ __('Enter encryption') }}" />
                                                    <p class="invalid-feedback" id="satellites_0_encryption"></p>
                                                </div>
                                ...
                                <div class="form-group">
                                    <div data-repeater-list="satellites">
                                        @foreach ($satellites ?? [] as $satellite)
                                            <div data-repeater-item>
                                                <div class="form-group row mt-5">
                                                    <input type="text" name="id" value="{{ $satellite['id'] }}"
                                                        hidden>
                                                    <div class="col-md-2">
                                                        <label class="form-label">{{ __('Name') }}</label>
                                                        <input type="text" class="form-control mb-2 mb-md-0"
