        ...
        <div class="card-body p-0">
            ...
            <form action="{{ route('dashboard.channel.update', $channel->id) }}" class="form" method="post"
                ...
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Edit Channel') }}</h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control" rows="4" name="description_ar" id="meta_tag_description_ar_inp">{{ $channel->description_ar }}</textarea>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control" rows="4" name="description_en" id="meta_tag_description_en_inp">{{ $channel->description_ar }}</textarea>
