    ...
    <div class="toolbar">
        ...
        <div  class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __("Models") }}</h1>
                <!-- end   :: Title -->
        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                ...
                <div class="d-flex flex-stack flex-wrap mb-15">
                    ...
                    <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                        ...
                        <select class="form-select form-select-solid border-gray-300 border-1 filter-datatable-inp" data-filter-index="3" data-control="select2" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}" data-placeholder="{{ __("Choose the brand") }}" >
                                <option value="" ></option>
                    ...
                    <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                        ...
                        <!-- begin :: Add Button -->
                        <a href="{{ route('dashboard.models.create',['type' => request('type')]) }}" class="btn btn-primary" data-bs-toggle="tooltip" title="">

                            <span class="svg-icon svg-icon-2">
                                <i class="fa fa-plus fa-lg"></i>
                            </span>

                            {{ request('type') == 'sub' ? __("Add new sub model") : __("Add new main model")}}
...
@push('scripts')
    <script>
        let modelsType = "{{ request('type') }}"
    </script>
    <script src="{{ asset('js/dashboard/datatables/datatables.bundle.js') }}"></script>
    <script src="{{ asset('js/dashboard/datatables/models.js') }}"></script>
    <script>
